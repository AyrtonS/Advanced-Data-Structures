...
public int height(Node r){
	...
	public static void main(String[] args){
		...
		menu();
		//System.err.println(bst.keys());
		//bst.printTree(bst.root);
		//System.out.println(bst.balancedTree(bst.root, 1));
		//System.out.println(bst.printTree(bst.root));
		
			//System.out.println(bst.depth(bst.root,23)+"|"+bst.depth(bst.root, 18));
		}
...
//BinarySearchTree<Integer, Integer> bst = new BinarySearchTree<>();
	...
	public static void menu(){
		...
		System.out.println("	[4] - Delete Keys");
		...
		switch(op){
				...
				System.out.println("	---------------------------------------------------------");
					...
					switch(tmp){
						...
						case 4:
							...
							System.out.println("The node's depth is : "+bsT.depth(bsT.root, key)+" Node(s)");
							menu();
			...
			case 4: 
				...
				System.out.println("	[1] - Delete minimum key");
				System.out.println("	[2] - Delete Maximum key");
				...
				System.out.println("	---------------------------------------------------------");
						...
						case 1: 
							bsT.deleteMin();
							System.out.println("Minimum key sucessfully deleted!");
							menu();
						case 2: 
							bsT.deleteMax();
							System.out.println("Maximum key sucessfully deleted!");
							menu();
						case 3:
							System.out.print("Which key would you like to delete?: ");
							int y = sc.nextInt();
								bsT.delete(y);
							System.out.println("Key sucessfully deleted!");
							menu();
						}
